...
function updateProductList() {
    ...
    let rightComponent =  document.querySelector('.component-right').style.display = 'block';
    listProduct.length > 0 ? rihrightComponentgt.style.display = 'block' : rihrightComponentgt.style.display = 'none';
}
