           ...
           <div class="component-product">
               ...
               <div class="product_info">
                   ...
                   <div class="select-quantity">
                       <div onclick="clickUpdateQuantity(this)" class="button-minus">-</div>
                       <input id="two-input" value="${item.quantity}" min="1" aria-valuemax="50" type="number" name=""
                           class="product-quantity">
                       <div onclick="clickUpdateQuantity(this)" class="button-maxnus">+</div>
                   </div>
               </div>
           </div>
       </div>
...
const clickUpdateQuantity = (element) => {
